...
aniversario = datetime.strptime(input('Digite a data de seu aniversário no formato dd/mm/aa: '), '%d/%m/%Y')


print(f"Olá {nome}, seu registro foi concluído com sucesso no dia, {data_cadastro.day}/{data_cadastro.month}/{data_cadastro.year}.\nParabéns, houve um sorteio e você ganhou uma cartão de compras no valor de R$ {cartao} ")
